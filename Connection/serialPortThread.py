...
class SerialPortThread(MakesmithInitFuncs):
    ...
    def getmessage (self):
        ...
        try:
            #print("connecting")
            self.serialInstance = serial.Serial(self.data.comport, 115200, timeout = 1) #self.data.comport is the com port which is opened
        except:
            ...
            while True:
                ...
                if time.time() - self.lastMessageTime > 100:
